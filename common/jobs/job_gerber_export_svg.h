...
#ifndef JOB_GERBER_EXPORT_SVG_H
#define JOB_GERBER_EXPORT_SVG_H
...
/**
 * Job to convert Gerber/Excellon files to SVG images.
 */
class KICOMMON_API JOB_GERBER_EXPORT_SVG : public JOB
{
public:
    JOB_GERBER_EXPORT_SVG();
